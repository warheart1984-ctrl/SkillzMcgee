...
**Status:** Dynamic â€” evolves with engineering

This directory contains **verification, evidence, and certification** â€” how we demonstrate the specification is true.
...
**Formal:** âˆ€V âˆˆ {tests, receipts, audits, certifications, provenance, drift checks, reproduction}: âˆƒR âˆˆ Requirements: resolves(V, R)

## Contents

| Path | Purpose |
|------|---------|
| [traceability-matrix.md](./traceability-matrix.md) | **Master audit matrix** (Req â†’ CTS â†’ MRI â†’ Evidence) |
...
| [compliance-profiles/](./compliance-profiles/) | C0â€“C6 badges |
...
| [federation/](./federation/) | F1â€“F6 tests + arbitration engine |
...
- [Don't Trust the Repository â€” Query It](../docs/public/dont-trust-query-it.md)
