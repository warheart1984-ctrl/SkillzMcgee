...
We identify bottlenecks, inefficiencies, risks, and opportunities based on what we observed. Every insight links back to specific observations.

---

## 3. Future State

We design improved workflows grounded in evidence, not assumptions. Each recommendation explains what should change, why, and what capabilities you need.
...
|-------------|-------------|
| **Current State Map** | How work flows today |
| **Analysis Report** | Findings from observed reality |
| **Future State Blueprint** | Recommended improvements |
