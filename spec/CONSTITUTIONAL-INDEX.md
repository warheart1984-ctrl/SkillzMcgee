# Constitutional Specification Index — Version 1.0
...
| [constitutional-stability-principle-1.0.md](./constitutional-stability-principle-1.0.md) | Final governing rule — semantics frozen, implementations free |
...
| [certification-profile-1.0.md](./certification-profile-1.0.md) | Defines C0–C3 certification levels and test requirements |
...
| [amendment-procedure-1.0.md](./amendment-procedure-1.0.md) | Formal procedure for constitutional amendments (→ 2.0) |
...
| [../specification/README.md](../specification/README.md) | CRK-1 Specification — invariants, object model, required behaviors |
| [../specification/constitutional-stack-v1.0.md](../specification/constitutional-stack-v1.0.md) | Six-layer stack contract (Authority → Communication) |
...
| [../conformance/proof-graph/README.md](../conformance/proof-graph/README.md) | Proof graph model — lineage, provenance, monotonicity |
| [../conformance/evidence-ledger/README.md](../conformance/evidence-ledger/README.md) | Evidence model — categories and canonical fields |
| [../conformance/provenance-ledger/spec.md](../conformance/provenance-ledger/spec.md) | Provenance model — cryptographic anchoring and reproducibility |
...
| [../conformance/proof-graph/index.schema.json](../conformance/proof-graph/index.schema.json) | Provenance Graph Interface (PGI) — schema |
...
| [../conformance/evidence-ledger/README.md](../conformance/evidence-ledger/README.md) | Evidence ledger — canonical evidence storage |
...
| [conformance-test-matrix-1.0.md](./conformance-test-matrix-1.0.md) | CTS-1.0 coverage matrix — requirement → test ID → evidence |
...
| [../docs/public/founders-log-entry-001.md](../docs/public/founders-log-entry-001.md) | Founder's Log — Entry #001 (2026-06-26) |
...
| Document | Purpose |
|----------|---------|
| [rfc-zero-v1.1.md](./rfc-zero-v1.1.md) | RFC-0 — Version 1.1 direction setting (draft) |
...
CONSTITUTIONAL-INDEX.md (this document)
        │
        ├── Baseline (§2) ─────────── platform identity, frozen
        │       └── stability · freeze · compatibility · charter · stewardship
        │
        ├── Specification (§3) ──── semantic grammar (CAR, CRK-1, proof graph)
        │
        ├── Conformance (§4) ────── verification (CTS, MRI, PGI, DRA, SEM)
        │
        ├── Operator (§5) ───────── inspection, forensics, scenarios
        │
        ├── Public (§6) ─────────── messaging, FAQ, founders, press
        │
        └── Evolution (§7) ──────── RFC-0, 1.1 planning, transition brief
```
...
**Effective freeze date:** 2026-06-26 — [version-1.0-freeze-declaration.md](./version-1.0-freeze-declaration.md)
