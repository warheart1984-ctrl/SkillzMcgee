...
|-------------|------|----------|
| Definition | [definition.md](./definition.md) | Scholars, press, docs |
| Manifesto | [manifesto.md](./manifesto.md) | Builders, funders, community |
| Classification framework | [classification-framework.md](./classification-framework.md) | Researchers, institutions |
